...
- DragonSuperPromoArmorConfig.cs: Example of ModConfig for custom mod settings;
- DragonSuperPromoArmorGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- DragonSuperPromoArmorMain.cs: Main mod class, recieves mod management and general events;
- DragonSuperPromoArmorTactical.cs: Example of ModTactical for modifying tactical level;
