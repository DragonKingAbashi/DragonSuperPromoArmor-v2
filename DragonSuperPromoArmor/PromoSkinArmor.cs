...
namespace DragonSuperPromoArmor
{
    internal class PromoSkinArmor
    {
        ...
        public static void AddAbilities()
        {
            ...
            TacticalItemDef HeavyHelmetGoldGold = Repo.GetAllDefs<TacticalItemDef>().FirstOrDefault(p => p.name.Equals("PX_Heavy_Helmet_Gold_BodyPartDef"));
            TacticalItemDef assaultHelmetxbox = Repo.GetAllDefs<TacticalItemDef>().FirstOrDefault(p => p.name.Equals("SY_Assault_Helmet_Neon_BodyPartDef"));
            TacticalItemDef assaultHelmetPS = Repo.GetAllDefs<TacticalItemDef>().FirstOrDefault(p => p.name.Equals("SY_Assault_Helmet_WhiteNeon_BodyPartDef"));
            TacticalItemDef SniperTorsoFirebird = Repo.GetAllDefs<TacticalItemDef>().FirstOrDefault(p => p.name.Equals("PX_Sniper_Torso_RisingSun_BodyPartDef"));
            TacticalItemDef HeavyHelmetChristmas = Repo.GetAllDefs<TacticalItemDef>().FirstOrDefault(p => p.name.Equals("PX_Heavy_Helmet_Christmas_BodyPartDef"));
            TacticalItemDef HeavyHelmetHeadhunter = Repo.GetAllDefs<TacticalItemDef>().FirstOrDefault(p => p.name.Equals("PX_Heavy_Helmet_Headhunter_BodyPartDef"));
            TacticalItemDef techniciantorsoPandorian = Repo.GetAllDefs<TacticalItemDef>().FirstOrDefault(p => p.name.Equals("NJ_Technician_Torso_ALN_BodyPartDef"));
            TacticalItemDef InfiltratorhelmetKaos = Repo.GetAllDefs<TacticalItemDef>().FirstOrDefault(p => p.name.Equals("SY_Infiltrator_Bonus_Helmet_BodyPartDef"));
            TacticalItemDef BerserkertorsoViking = Repo.GetAllDefs<TacticalItemDef>().FirstOrDefault(p => p.name.Equals("AN_Berserker_Torso_Viking_BodyPartDef"));
            TacticalItemDef LivingtorsoChitin = Repo.GetAllDefs<TacticalItemDef>().FirstOrDefault(p => p.name.Equals("PX_Chitin_Torso_ItemDef"));
            ...
            if (Config.PromoArmorSkinsHaveSpecialAbilities == true)
            {
                InfiltratorhelmetKaos.Abilities = new AbilityDef[]
                {
                    Repo.GetAllDefs<ApplyStatusAbilityDef>().FirstOrDefault(p => p.name.Equals("SenseLocate_AbilityDef")),
                };
                techniciantorsoPandorian.Abilities = new AbilityDef[]
                {
                    Repo.GetAllDefs<ApplyEffectAbilityDef>().FirstOrDefault(p => p.name.Equals("BonusArmor2_AbilityDef")),
                };
                HeavyHelmetGoldGold.Abilities = new AbilityDef[]
                {
                    Repo.GetAllDefs<ApplyStatusAbilityDef>().FirstOrDefault(p => p.name.Equals("WarCry_AbilityDef")),
                };
                HeavyHelmetHeadhunter.Abilities = new AbilityDef[]
                {
                    Repo.GetAllDefs<ApplyStatusAbilityDef>().FirstOrDefault(p => p.name.Equals("WarCry_AbilityDef")),
                };
                HeavyHelmetChristmas.Abilities = new AbilityDef[]
                {
                    Repo.GetAllDefs<ApplyStatusAbilityDef>().FirstOrDefault(p => p.name.Equals("WarCry_AbilityDef")),
                };
                assaultHelmetGold.Abilities = new AbilityDef[]
                {
                    Repo.GetAllDefs<ApplyStatusAbilityDef>().FirstOrDefault(p => p.name.Equals("Rally_AbilityDef")),
                };
                assaultHelmetxbox.Abilities = new AbilityDef[]
                {
                    Repo.GetAllDefs<ApplyStatusAbilityDef>().FirstOrDefault(p => p.name.Equals("Rally_AbilityDef")),
                };
                assaultHelmetPS.Abilities = new AbilityDef[]
                {
                    Repo.GetAllDefs<ApplyStatusAbilityDef>().FirstOrDefault(p => p.name.Equals("Rally_AbilityDef")),
                };
                SniperTorsoFirebird.Abilities = new AbilityDef[]
                {
                    Repo.GetAllDefs<ApplyStatusAbilityDef>().FirstOrDefault(p => p.name.Equals("CrystalStacks_DamageAmplification_AbilityDef")),
                };
                BerserkertorsoViking.Abilities = new AbilityDef[]
                {
                    viralAreaAttack,
                };
                LivingtorsoChitin.Abilities = new AbilityDef[]
                {
                    Repo.GetAllDefs<ApplyStatusAbilityDef>().FirstOrDefault(p => p.name.Equals("CrystalStacks_DamageAmplification_AbilityDef")),
                    viralAreaAttack,
                };
